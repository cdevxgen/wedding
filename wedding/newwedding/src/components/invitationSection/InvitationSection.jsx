...
const InvitationSection = () => {
  const handleSaveDate = () => {
    ...
    const receptionStartDate = new Date("2024-11-23T18:30:00Z"); // 6:30 PM UTC
    const receptionEndDate = new Date("2024-11-23T23:00:00Z"); // 11:00 PM UTC

    const muhurthamStartDate = new Date("2024-11-24T09:00:00Z"); // 9:00 AM UTC
    const muhurthamEndDate = new Date("2024-11-24T10:15:00Z"); // 10:15 AM UTC
    ...
    try {
        ...
        if (window.URL && window.URL.createObjectURL) {
            ...
            // Remove the link element after download is triggered
            document.body.removeChild(link);
        } else {
            alert("Your browser does not support Blob URLs, please use a modern browser.");
        }
    } catch (error) {
