...
import { addLeadingZero } from "../../helpers/addLeadingZero"; // import addLeadingZero from "../../helpers/addLeadingZero";
import services from "../../data/services";

import Container from "./Container";
import ServicePicture from "./ServicesPicture";
        ...
        {services.map((service) => {
          ...
          return (
            <SwiperSlide key={shortcut}>
              ...
              >
                <Container>
                  <div className="flex flex-col gap-[16px] text-white tablet:gap-[36px] desktop:gap-[24px]">
                    <div className="flex flex-col tablet:flex-row tablet:items-center gap-[24px] tablet:gap-[170px]">
                      <h2 className="text-heading text-white">
                        {/* our <span className="font-medium">Celebrations</span> */}
