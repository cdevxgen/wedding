...
export const metadata = {
  ...
  icons: {
    icon: "/path/to/logo.png", // Replace with the actual path to your logo
  },
  openGraph: {
    title: "Mahesh & ShreeRaksha Wedding",
    description: "Join us in celebrating the wedding of Mahesh N Shetty & ShreeRaksha R Shetty.",
    image: "/logo.jpg", // Replace with the image for sharing on social media
  ...
  twitter: {
    ...
    title: "Mahesh & ShreeRaksha Wedding",
    description: "Join us in celebrating the wedding of Mahesh N Shetty & ShreeRaksha R Shetty.",
    image: "/logo.jpg", // Replace with your Twitter image
  },
};
